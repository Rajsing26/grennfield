...
namespace BankingPortal.Models
{
    ...
    public class AuthService : IAuthService
    {
        ...
        public bool Seeding()
        {
            ...
            IDataRepository<Credenail> dataRepository = new JsonDataRepository<Credenail>();
        ...
        {
            List<Credenail> credentials = new List<Credenail>();
            IDataRepository<Credenail> repository = new JsonDataRepository<Credenail>();
